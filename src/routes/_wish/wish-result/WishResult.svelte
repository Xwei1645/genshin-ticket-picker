...
>
	...
	{:else}
		...
		>
			{#each list as { name, rarity, type, outfitName, vision, weaponType, bonusQty, bonusType, ticketNo, stelaFortuna, useOutfit, offset, custom }, i}
				{#if activeIndex === i}
					<div class="art-wrapper">
						...
						<ItemInfo
							...
							{stelaFortuna}
							{custom}
							hideExtraRewards={hideWishExtras}
						/>
						<WeaponBonus
							{type}
							{bonusType}
